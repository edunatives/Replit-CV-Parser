...
function transformToFull(raw, audience) {
    ...
    const output = {
        ...
        studentAnalysis: audience === "STUDENT" ? studentAnalysisRaw : undefined,
        hrAnalysis: audience === "HR" ? hrAnalysisRaw : undefined
    };
    return output;
}
...
"[project]/app/api/providers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const providers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$langchain$2f$llm$2d$providers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAvailableProviders"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c43ea03b._.js.map